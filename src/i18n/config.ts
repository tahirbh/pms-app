...
const resources = {
  en: {
    translation: {
      ...
      "version_history_subtitle": "Detailed log of all improvements, new features, and bug fixes.",
      "features": "Features",
      "bug_fixes": "Bug Fixes",
  ...
  ar: {
    translation: {
      ...
      "version_history_subtitle": "سجل مفصل لجميع التحسينات والميزات الجديدة وإصلاحات الأخطاء.",
      "features": "الميزات",
      "bug_fixes": "إصلاحات",
  ...
  ur: {
    translation: {
      ...
      "version_history_subtitle": "تمام بہتری، نئی خصوصیات اور بگ فکسز کا تفصیلی لاگ۔",
      "features": "خصوصیات",
      "bug_fixes": "بگز فکس",
